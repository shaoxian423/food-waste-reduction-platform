...
-- DELIMITER ;
 ...
 USE FWRP;
INSERT INTO retailer_inventory (retailer_id, item_name, quantity, expiry_date, price, discount_rate, location, is_surplus, is_for_donation)
VALUES (2, 'Milk', 20, '2024-12-31', 2.99, 0.10, 'Aisle 3', TRUE, FALSE);
